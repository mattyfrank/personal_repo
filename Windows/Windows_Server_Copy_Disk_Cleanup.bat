...
echo Copying: Cleanmgr.exe
copy \\HskServer\C$\Windows\WinSxS\amd64_microsoft-windows-cleanmgr_31bf3856ad364e35_6??.3.9600.16384_none_5e02966c3182d7a7\cleanmgr.exe %SystemRoot%\System32*.*
echo Copying: Cleanmgr.exe.mui
copy \\HskServer\C$\Windows\WinSxS\amd64_microsoft-windows-cleanmgr.resources_31bf3856??ad364e35_6.3.9600.16384_en-us_4e94cff86c9dcc30\cleanmgr.exe.mui %SystemRoot%\System32\en-US*.*
goto shortcut
